<template>
  <div class="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      >
        ...
        <div class="p-4 bg-slate-900/80 border-b border-slate-700 flex justify-between items-center">
          <div class="flex items-center">
            <div class="w-8 h-8 rounded-full bg-gradient-to-r from-teal-400 to-indigo-500 flex items-center justify-center text-xs font-bold mr-3 text-white">
              AI
            </div>
            <div>
        ...
        <div class="p-3 bg-slate-900/80 border-t border-slate-700">
          ...
          >
            ...
            <button
              type="submit"
              :disabled="!userMessage || isChatting"
    ...
    >
      ...
      <span
        v-if="!chatOpen"
        class="absolute top-0 right-0 w-4 h-4 bg-red-500 border-2 border-slate-900 rounded-full"
      />
    </button>
  </div>
</template>
...
const { chatWithResume } = useGemini()
